package com.example.phase1.pool;
...
public class ConnectionPool {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/coupons_phase_1?user=root" +
            "&password=1234&useUnicode=true&useJDBCCompliantTimezoneShift=true" +
